...
class Vector
{
   public:
	  ...
	  */
      ...
      /*!
	  * Function assigning a linear combination of four vector to the current one
	  * @param[in] v1
	  * @param[in] v2
	  * @param[in] v3
      * @param[in] v4
      ...
      * @param[in] c4
	  */
      Vector& equ(const Vector& v1,const Vector& v2, const Vector& v3, const Vector& v4,
	  ...
	  */
      ...
      /*!
	  * Function adding a linear combination of four vector to the current one
	  * @param[in] v1
	  * @param[in] v2
	  * @param[in] v3
      * @param[in] v4
      ...
      * @param[in] c4
	  */
      Vector& sadd(const Vector& v1,const Vector& v2, const Vector& v3, const Vector& v4,
                   const double& c1,const double& c2, const double& c3, const double& c4);     
...
// Scaled addition of four vectors and storage directly into another vector
inline
Vector& Vector::equ(const Vector& v1,const Vector& v2, const Vector& v3, const Vector& v4,
                   const double& c1,const double& c2, const double& c3, const double& c4)
{                     
   x = v1.x*c1 + v2.x*c2 + v3.x*c3 + v4.x*c4;
   y = v1.y*c1 + v2.y*c2 + v3.y*c3 + v4.y*c4;
   z = v1.z*c1 + v2.z*c2 + v3.z*c3 + v4.z*c4;
...
// Scaled addition of four vectors to an existing vector
inline
Vector& Vector::sadd(const Vector& v1,const Vector& v2, const Vector& v3, const Vector& v4,
                   const double& c1,const double& c2, const double& c3, const double& c4)
{                     
   x += v1.x*c1 + v2.x*c2 + v3.x*c3 + v4.x*c4;
   y += v1.y*c1 + v2.y*c2 + v3.y*c3 + v4.y*c4;
