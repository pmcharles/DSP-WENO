...
class ConVar
{
   public:
      ...
      /*!
	  * Operator copying one conserved variable vector into the current one
	  * @param[in] con_var 
	  */
      ConVar& operator=  (const ConVar& con_var);
      
      /*!
	  * Operator adding one conserved variable vector into the current one
	  * @param[in] con_var 
	  */
      ConVar& operator+= (const ConVar& con_var);
