...
//------------------------------------------------------------------------------
// KEPES TeCNO4 ROE Flux
//------------------------------------------------------------------------------
void FV::kepes_tecno4_roe_flux (const vector<PrimVar> &P,
...
{  
   ...
   double psqrt = sqrt(p);
   //cout << vel.x << " " << vel.y << " " << vel.z << " " <<  0.5*vel.square() << endl;
   //cout << rho << endl;
   //cout << const1 << endl;
   ...
   double ev_mod_beta =0.0/6.0;
   double ev_mod_alpha = 0.0/6.0;
   ...
   //cout << R[4][0] << " " << R[4][1] << " " << R[4][2] << " " << R[4][3] << " " << R[4][4] << endl;
